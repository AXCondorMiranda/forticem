...
const productCategories = [
  {
    ...
    href: "#linea-aditivos",
    children: [
      { label: "FORTICEM FLOW", meta: "Plastificante", href: "aditivos/flow/" },
      { label: "FORTICEM FLOW+", meta: "Superplastificante", href: "aditivos/flow-plus/" },
      { label: "FORTICEM CURE", meta: "Curador de concreto", href: "aditivos/cure/" },
      { label: "FORTICEM FAST", meta: "Acelerante", href: "aditivos/fast/" },
      { label: "FORTICEM RELEASE", meta: "Desmoldante", href: "aditivos/release/" },
      { label: "FORTICEM SEAL", meta: "Impermeabilizante", href: "aditivos/seal/" },
    ],
  },
  {
    label: "Block Grass",
    href: "productos/block-grass/",
    children: [
      { label: "Tipo Michi", meta: "35 × 35 × 9 cm", href: "productos/block-grass/#michi" },
      { label: "Tipo 8", meta: "22 × 41 × 9 cm", href: "productos/block-grass/#tipo-8" },
    ],
  },
  {
    label: "Bloques",
  ...
  },
  {
    ...
    href: "productos/separadores-concreto/",
    type: "measure",
    note: "Uso orientativo. Validar recubrimiento según planos, exposición y especificación técnica.",
    children: [
      { label: "2 cm", meta: "Losas y muros interiores", href: "productos/separadores-concreto/#medidas" },
      { label: "2.5 cm", meta: "Losas aligeradas y techos", href: "productos/separadores-concreto/#medidas" },
      { label: "3 cm", meta: "Vigas y losas según plano", href: "productos/separadores-concreto/#medidas" },
      { label: "3.5 cm", meta: "Elementos según plano", href: "productos/separadores-concreto/#medidas" },
      { label: "4 cm", meta: "Columnas y vigas", href: "productos/separadores-concreto/#medidas" },
      { label: "5 cm", meta: "Elementos expuestos", href: "productos/separadores-concreto/#medidas" },
      { label: "6 cm", meta: "Recubrimiento especial", href: "productos/separadores-concreto/#medidas" },
      { label: "7 cm", meta: "Concreto contra el suelo", href: "productos/separadores-concreto/#medidas" },
      { label: "7.5 cm", meta: "Exposición especial", href: "productos/separadores-concreto/#medidas" },
      { label: "10 cm", meta: "Obras especiales", href: "productos/separadores-concreto/#medidas" },
    ],
  },
...
const solutionCategories = [
  { label: "Mejorar trabajabilidad", href: "aditivos/flow/" },
  { label: "Acelerar fraguado", href: "aditivos/fast/" },
  { label: "Retardar fraguado", href: "#soluciones" },
  { label: "Curado", href: "aditivos/cure/" },
  { label: "Impermeabilización", href: "aditivos/seal/" },
  { label: "Desmolde", href: "aditivos/release/" },
  { label: "Control de aire", href: "#soluciones" },
  { label: "Reducir burbujas", href: "#soluciones" },
  { label: "Recubrimiento de acero", href: "#soluciones" },
  { label: "Block Grass", href: "productos/block-grass/" },
];
...
const footerSections = [
  ...
  },
  {
    title: "Recursos",
    links: [
      { label: "Familia Block Grass", href: "productos/block-grass/" },
